...
CPU_RAM="0.055" # The CPU RAM you would like to provide in GiB. Be somewhat conservative here. E. g., if your machine has 32 GB RAM, set 25  
GPU_RAM="6.0" # The GPU RAM you would like to provide in GiB. Be a litte conservative here. E. g., if your GPU has 6 GB RAM, set 5.25
