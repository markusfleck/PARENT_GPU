...
IN_NAME="trash/test_system/UBQ_UBM2" # The name and location of your trajectory (.xtc) and topology (.top) files
OUT_NAME_BAT="output/UBQ_UBM2" # The name and location of the output
OUT_NAME="output/UBQ_UBM2" # The name and location of the output
